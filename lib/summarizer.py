...
class BackTest(object):
    ...
    def __init__(self,name='user-created'):
    ...
    def __repr__(self):
        return 'BackTest(name = [{1}], trades=[{2}], net={0.net}, cumReturn={0.cumReturn}%, annuReturn={0.annualizedReturn}%)'.format(self, self.name, len(self.trades))
